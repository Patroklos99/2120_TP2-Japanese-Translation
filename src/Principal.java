...
public class Principal {
     ...
     *
     * @param args <code>var nom, string du nom du fichier ecrit par l'usager</code>
     */
    ...
    public static void msgEntree() {
        System.out.println("\nVeuillez entrer le nom de votre fichier dans le terminal (suivi de son suffixe .txt):");
    }
