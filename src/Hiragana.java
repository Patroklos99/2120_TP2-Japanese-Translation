...
public class Hiragana {
    protected ArrayList<String> tabSyllabes;
    protected Map<String, String> tabHiragana = new HashMap<>();

    public Hiragana(ArrayList<String> tab) {
        this.tabSyllabes = tab;
        remplirTabHiragana();
    ...
    private void afficherSyllabes() {
        for (String key : tabSyllabes) {
            if (tabHiragana.containsKey(key)) {
                System.out.println("La clé est " + key + ", La valeur est " + tabHiragana.get(key));
            }
        }
